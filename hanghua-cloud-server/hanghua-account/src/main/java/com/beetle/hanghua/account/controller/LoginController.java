...
@RestController
@RequestMapping("/hanghua-account")
public class LoginController {
    ...
    public ResultDTO forgetPassword(@RequestParam("account") String account,
                                    @RequestParam("accessToken") String accessToken) {
     ...
     */
    @GetMapping("logout")
    public ResultDTO manualLoginLogout(@RequestParam("account") String account,
                                       @RequestParam("accessToken") String accessToken) {
